"""Export Enemy5 actions without rotation and overwrite models/Enemy_05_*."""
...
EXPECTED_SOURCE = WORKSPACE_DIR.parent / "Enemy_5.blend"
MODELS_DIR = WORKSPACE_DIR.parents[1] / "models"
EXPECTED_ACTIONS = {"aim", "attack", "idle"}
...
def prepare_armature() -> bpy.types.Object:
    armatures = [
        obj
...
def main() -> None:
    ...
    for action_name in action_names:
        ...
        basename = f"Enemy_05_{safe_name(action_name)}"
    ...
    print("CODEX_ENEMY5_EXPORT_RESULTS=" + json.dumps(results, ensure_ascii=False))
