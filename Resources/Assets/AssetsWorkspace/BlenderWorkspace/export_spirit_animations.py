"""Export Spirit actions with a world-Z 180-degree turn into models."""
...
EXPECTED_SOURCE = WORKSPACE_DIR.parent / "Spirit.blend"
MODELS_DIR = WORKSPACE_DIR.parents[1] / "models"
EXPECTED_ACTIONS = {"attack1", "attack2", "dodge", "idle", "move"}
...
def main() -> None:
    ...
    for action_name in action_names:
        ...
        basename = f"Spirit_{safe_name(action_name)}"
        ...
        results.append(
            {
                ...
                "orientation": "world Z+180deg",
            }
        )

    print("CODEX_SPIRIT_EXPORT_RESULTS=" + json.dumps(results, ensure_ascii=False))
