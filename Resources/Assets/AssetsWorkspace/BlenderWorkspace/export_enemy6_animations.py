"""Export Enemy6 actions with a world-Z 180-degree turn into models."""
...
EXPECTED_SOURCE = WORKSPACE_DIR.parent / "Enemy6.blend"
MODELS_DIR = WORKSPACE_DIR.parents[1] / "models"
EXPECTED_ACTIONS = {"aim", "idle"}
...
def main() -> None:
    ...
    for action_name in action_names:
        ...
        basename = f"Enemy_06_{safe_name(action_name)}"
    ...
    print("CODEX_ENEMY6_EXPORT_RESULTS=" + json.dumps(results, ensure_ascii=False))
